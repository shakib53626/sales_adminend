...
const getUserDetailInfo = async() =>{
    ...
    if(res.success){
        ...
        phoneNumber.value  = res.result?.phone_number;
                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-md-12">
                            <div class="d-flex justify-content-end">
                                <button class="btn btn-add" @click="submit" v-if="user.loading"><i class="fa-solid fa-spinner fa-spin"></i> Loading....</button>
                                <button class="btn btn-add" @click="submit" v-else>Update User </button>
                            </div>
                        </div>
                    </div>
                </div>
